describe("Myna.init", function() {
  ...
  it("should not affect jQuery", function() {
    var numMethods1a = Object.keys(Myna.$).length;
    var numMethods1b = Object.keys(Myna.$.fn).length;

    var myna = Myna.init({});

    var numMethods2a = Object.keys(Myna.$).length;
    var numMethods2b = Object.keys(Myna.$.fn).length;
