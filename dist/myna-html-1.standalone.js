...
Myna = (function(window, document) {
  ...
  return Myna = (function() {
    ...
    function Myna(options) {
      ...
      $.each(this.options.experiments, function(index, options) {
        ...
        if (uuid && cssClass) {
          ...
          return _this.log("initExperiment: no uuid or CSS class", options, uuid, cssClass, sticky);
        }
      });
    }
    ...
    Myna.prototype.showVariant = function(options, choice) {
      return this.eachVariantAndGoal(options.cssClass, options.dataPrefix, function(show, bind, goal) {
        var match;
        if (show) {
          switch (show) {
            case choice:
    ...
    Myna.prototype.initGoals = function(options) {
      return this.eachVariantAndGoal(options.cssClass, options.dataPrefix, function(show, bind, goal) {
        switch (goal) {
          case "click":
    ...
    Myna.prototype.initExperiment = function(options) {
      var error, stored, success, uuid,
        _this = this;
      uuid = options.uuid;
      stored = this.loadSuggestion(uuid);
      this.log("initExperiment", uuid, stored);
      success = function(stored) {
        _this.showVariant(options, stored.choice);
        if (!stored.skipped && !stored.rewarded && stored.token) {
          _this.initGoals(options);
        }
      };
      error = function() {
        var choice;
        ...
        if (choice) {
          _this.showVariant(options, choice);
        }
      };
